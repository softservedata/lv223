...
public class SortingPage extends AMenuPage{
	...
	public WebElement getSortOptionNameAZ(){
		clickSortOptionsDropMenu();
		return this.sortOptionsMenu.sortOptionNameAZ;
	}
	
	public WebElement getSortOptionNameZA(){
		clickSortOptionsDropMenu();
		return this.sortOptionsMenu.sortOptionNameZA;
	}
	...
	//functional
	public SortingPage gotoShowOption15() {
		clickShowOption15();
        return new SortingPage(driver);
    }
	
	public SortingPage gotoShowOption25() {
		clickShowOption25();
        return new SortingPage(driver);
    }
	
	public SortingPage gotoShowOption50() {
		clickShowOption50();
        return new SortingPage(driver);
    }
	
	public SortingPage gotoShowOption75() {
		clickShowOption75();
        return new SortingPage(driver);
    }
	
	public SortingPage gotoShowOption100() {
		clickShowOption100();
        return new SortingPage(driver);
    }
	
	public SortingPage gotoSortOptionDefault() {
		clickSortOptionDefault();
        return new SortingPage(driver);
    }
	
	public SortingPage gotoSortOptionNameAZ() {
		clickSortOptionNameAZ();
        return new SortingPage(driver);
    }
	
	public SortingPage gotoSortOptionNameZA() {
		clickSortOptionNameZA();
        return new SortingPage(driver);
    }
	
	public SortingPage gotoOptionPriceLowHigh() {
		clickSortOptionPriceLowHigh();
        return new SortingPage(driver);
    }
	
	public SortingPage gotoOptionPriceHighLow() {
		clickSortOptionPriceHighLow();
        return new SortingPage(driver);
    }
	
	public SortingPage gotoSortOptionRatingHighest() {
		clickSortOptionRatingHighest();
        return new SortingPage(driver);
    }
	
	public SortingPage gotoSortOptionRatingLowest() {
		clickSortOptionRatingLowest();
        return new SortingPage(driver);
    }
	
	public SortingPage gotoSortOptionModelAZ() {
		clickSortOptionModelAZ();
        return new SortingPage(driver);
    }	
	
	public SortingPage gotoSortingTypeGrid() {
		clickSortingTypeGrid();
        return new SortingPage(driver);
    }
	
	public SortingPage gotoSortingTypeList() {
		clickSortingTypeList();
        return new SortingPage(driver);
    }
	
	public SortingPage gotoProductCompare() {
		clickProductCompare();
		/////Should return product compare depending on items selected.
        return new SortingPage(driver);
    }
}
